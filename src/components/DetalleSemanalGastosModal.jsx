          ...
          <div className="modal-body">
                        ...
                        <>
                          ...
                          <div className="small">
                            {asignacionesDia.length > 0 ? (
                              asignacionesDia.map((asignacion, idx) => (
                                <div key={idx} className="border-bottom pb-1 mb-1">
                                  <small className="text-warning d-block">
                                    <strong>{asignacion.nombreCosto || 'Gasto General'}</strong>
                                  </small>
                                  <small className="text-muted">
                                    ${asignacion.importeAsignado || asignacion.importe}
                              ...
                              <small className="text-muted">Sin gastos asignados</small>
                            )}
                          </div>
                        </>
                      ) : (
            ...
            <div className="alert alert-light mt-3">
              ...
              <ul className="mb-0 mt-2">
                <li><strong>Gastos fijos:</strong> Seguros, alquileres (distribuir uniformemente)</li>
                <li><strong>Gastos variables:</strong> Combustible, servicios (según actividad diaria)</li>
                <li><strong>Gastos puntuales:</strong> Materiales específicos, equipos (días específicos)</li>
              </ul>
            </div>
          </div>
...
export default DetalleSemanalGastosModal;
